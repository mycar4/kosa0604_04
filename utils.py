...
# OpenAPI 서버 : 답변 잘해주는 쌤 : 예) ai = new OpenAI(); <-- 자바
sync_client = OpenAI( api_key=OPENAI_API_KEY, ) # 놀이공원 입장권으로 생각!
...
def llm_call(prompt: str,  model: str = "gpt-4o-mini") -> str:
    ...
    return chat_completion.choices[0].message.content  # 샘이 보낸 답장
